...
namespace PokEmuBasic.Infrastructure.Migrations
{
    ...
    [Migration("20251125201907_UpdateDB261125")]
    partial class UpdateDB261125
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PokEmuBasic.Domain.Entities.Card", b =>
                {
                    ...
                    b.HasOne("PokEmuBasic.Domain.Entities.Expansion", "Expansion")
                        ...
                        .HasConstraintName("fk_cards_expansions_expansion_id");
            ...
            modelBuilder.Entity("PokEmuBasic.Domain.Entities.Pack", b =>
                {
                    b.HasOne("PokEmuBasic.Domain.Entities.Expansion", "Expansion")
                        .WithMany("Packs")
                        .HasForeignKey("ExpansionId")
                        .HasConstraintName("fk_packs_expansions_expansion_id");
